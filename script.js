...
/* =========================================================
   MISAIRA PUNKT 8 – EIGENE FARBEN FINAL
   Darstellung bleibt unverändert.
========================================================= */

(function () {

    const MISAIARA_COLORS = {

        cyan: {
            name: "Cyan",
            main: "#00eaff",
            glow: "rgba(0,234,255,.65)",
            soft: "rgba(0,234,255,.22)"
        },

        purple: {
            name: "Purple",
            main: "#8a2cff",
            glow: "rgba(138,44,255,.65)",
            soft: "rgba(138,44,255,.22)"
        },

        pink: {
            name: "Pink",
            main: "#f72cff",
            glow: "rgba(247,44,255,.65)",
            soft: "rgba(247,44,255,.22)"
        },

        blue: {
            name: "Blau",
            main: "#218cff",
            glow: "rgba(33,140,255,.65)",
            soft: "rgba(33,140,255,.22)"
        },

        green: {
            name: "Grün",
            main: "#00e6a7",
            glow: "rgba(0,230,167,.65)",
            soft: "rgba(0,230,167,.22)"
        },

        orange: {
            name: "Orange",
            main: "#ff8a2c",
            glow: "rgba(255,138,44,.65)",
            soft: "rgba(255,138,44,.22)"
        },

        yellow: {
            name: "Gelb",
            main: "#ffd32c",
            glow: "rgba(255,211,44,.65)",
            soft: "rgba(255,211,44,.22)"
        },

        red: {
            name: "Rot",
            main: "#ff3d5a",
            glow: "rgba(255,61,90,.65)",
            soft: "rgba(255,61,90,.22)"
        }
    ...
    /* =====================================================
       ANIMATION-FARBE ANWENDEN
    ===================================================== */

    function applyPersonalAnimationColor(
        colorKey
    ) {

        const color =
            MISAIARA_COLORS[colorKey] ||
            MISAIARA_COLORS.cyan;


        selectedColor =
            colorKey in MISAIARA_COLORS
                ? colorKey
                : "cyan";
        ...
        root.style.setProperty(
            "--misaira-personal-soft",
            color.soft
        );


        /*
         * Bestehende MISAIRA-Core-Animation
         * farblich überschreiben.
         *
         * Die Animation selbst bleibt bestehen.
         */

        document
            .querySelectorAll(
                ".welcome-core .core-glow"
            )
            .forEach(
                element => {
        ...
        document
            .querySelectorAll(
                ".welcome-core .orbit-1, " +
                ".welcome-core .orbit-2, " +
                ".welcome-core .orbit-3"
            )
            .forEach(
                element => {
        ...
        /*
         * Farbvariable für weitere
         * MISAIRA-Animationen.
         */

        root.dataset.misairaPersonalColor =
            selectedColor;
    ...
    /* =====================================================
       FARBBEREICH ERSTELLEN
    ===================================================== */

    function renderPersonalColors() {
        ...
        wrapper.className =
            "misaira-personal-colors";


        wrapper.innerHTML = `

            <div class="misaira-personal-colors-head">
                ...
                <p>
                    Wähle deine persönliche
                    Farbe für die MISAIRA-Animation.
                </p>

            </div>


            <div class="misaira-personal-color-grid">
                ...
                .map(
                    ([key, color]) => `
                        ...
                        <button
                            type="button"
                            class="misaira-personal-color-button"
                            data-misaira-personal-color="${key}"
                            style="--personal-color:${color.main}"
                        >

                            <span
                                class="misaira-personal-color-dot"
                            ></span>
            ...
            <div class="misaira-personal-color-current">

                Aktuelle Auswahl:

                <strong
                    id="misairaPersonalColorName"
                >
                    Cyan
                </strong>
            ...
            <div class="misaira-personal-color-preview">

                <div
                    class="misaira-personal-preview-core"
                >
                    M
                </div>
                ...
                <div>
                    ...
                    <small>
                        Die Animation übernimmt
                        deine ausgewählte Farbe.
                    </small>
            ...
            <div class="misaira-personal-color-actions">

                <button
                    type="button"
                    id="misairaPersonalColorSave"
                    class="primary-button"
                >
                    SPEICHERN
                </button>
            ...
            <div
                id="misairaPersonalColorMessage"
                class="form-message"
            ></div>
        ...
        /*
         * Unter Glow + Animationen einsetzen.
         */
    ...
    async function savePersonalColor() {
        ...
        try {
            ...
            showPersonalColorMessage(
                "Farbe wurde gespeichert.",
                "success"
            );
    ...
    async function resetPersonalColor() {
        ...
        await savePersonalColor();


        showPersonalColorMessage(
            "Farbe auf Cyan zurückgesetzt.",
            "success"
        );
    ...
    function showPersonalColorMessage(
        message,
        type
    ) {
...
/* =========================================================
   MISAIRA PUNKT 8 – EIGENE FARBEN
   FIX – KEINE DOPPELTE ANZEIGE
========================================================= */

(function () {

    const COLORS = {
        cyan:   { name: "Cyan",   color: "#00eaff" },
        purple: { name: "Purple", color: "#8a2cff" },
        pink:   { name: "Pink",   color: "#ff2ca8" },
        blue:   { name: "Blau",   color: "#3d7cff" },
        green:  { name: "Grün",   color: "#00e6a7" },
        orange: { name: "Orange", color: "#ff8a2c" },
        yellow: { name: "Gelb",   color: "#ffd32c" },
        red:    { name: "Rot",    color: "#ff3d5a" }
    };
    ...
    function addPersonalColors() {
        ...
        /*
         * WICHTIG:
         * Falls bereits vorhanden → nichts
         * nochmals erzeugen.
         */
        ...
        box.innerHTML = `
            ...
            <div class="misaira-personal-title">
                EIGENE FARBEN
            </div>

            <div class="misaira-personal-description">
                Wähle deine persönliche
                MISAIRA-Animationsfarbe.
            </div>


            <div class="misaira-personal-grid">
                ...
                ${Object.entries(COLORS)
                    .map(
                        ([key, item]) => `
                            ...
                            <button
                                type="button"
                                class="misaira-personal-color"
                                data-personal-color="${key}"
                            >
            ...
            <div class="misaira-personal-current">

                Aktuelle Farbe:

                <strong
                    id="misairaPersonalCurrent"
                >
                    Cyan
                </strong>
            ...
            <div class="misaira-personal-actions">

                <button
                    type="button"
                    id="misairaPersonalSave"
                >
                    SPEICHERN
                </button>
    ...
    function applyColor(
        ...
        /*
         * Persönliche Farbe an vorhandene
         * MISAIRA-Core-Elemente geben.
         */

        document
            .querySelectorAll(
                ".core-glow, .core-orbit, .core-letter"
            )
            .forEach(
                element => {
    ...
    async function saveColor() {
        ...
        try {
            ...
            alert(
                "Eigene Farbe wurde gespeichert."
            );
    ...
    async function resetColor() {
        ...
        try {
            ...
            alert(
                "Eigene Farbe wurde auf Cyan zurückgesetzt."
            );
...
(function () {
    ...
    const COLORS = {
        ...
        purple: {
            name: "Purple",
            main: "#8a2cff",
            glow: "rgba(138,44,255,.70)"
        },

        pink: {
            name: "Pink",
            main: "#ff2ca8",
            glow: "rgba(255,44,168,.70)"
        },

        blue: {
            name: "Blau",
            main: "#3d7cff",
            glow: "rgba(61,124,255,.70)"
        },

        green: {
            name: "Grün",
            main: "#00e6a7",
            glow: "rgba(0,230,167,.70)"
        },

        orange: {
            name: "Orange",
            main: "#ff8a2c",
            glow: "rgba(255,138,44,.70)"
        },

        yellow: {
            name: "Gelb",
            main: "#ffd32c",
            glow: "rgba(255,211,44,.70)"
        },

        red: {
            name: "Rot",
            main: "#ff3d5a",
            glow: "rgba(255,61,90,.70)"
        }
    ...
    /* =====================================================
       CSS-FARBEN GLOBAL SETZEN
    ===================================================== */

    function setColorVariables(colorKey) {
    ...
    /* =====================================================
       VORHANDENE MISAIRA ANIMATION
       FARBLİCH ÜBERSCHREIBEN
    ===================================================== */

    function applyColorToExistingAnimation(
        color
    ) {
        ...
        /*
         * Alle vorhandenen Core-Elemente.
         */
        ...
        /*
         * Weitere Elemente, die CSS-Variablen
         * verwenden können.
         */
    ...
    /* =====================================================
       EIGENE FARBEN EINMALIG ERZEUGEN
    ===================================================== */
    ...
    function ensureColorPanel() {
        ...
        panel.innerHTML = `
            ...
            <div
                class="misaira-personal-title"
            >
                EIGENE FARBEN
            </div>

            <div
                class="misaira-personal-description"
            >
                Wähle deine persönliche
                MISAIRA-Animationsfarbe.
            </div>
            ...
            <div
                class="misaira-personal-current"
            >
            ...
            <div
                class="misaira-personal-actions"
            >
    ...
    function showColorMessage(
        ...
        if (!messageBox) {
            ...
            messageBox.style.color =
                "var(--misaira-personal-color)";


            const actions =
                document.querySelector(
                    ".misaira-personal-actions"
                );
